...
CREATE TABLE `subjects` (
  ...
  `NumberOfCourceInc` int DEFAULT NULL,
  `DateOfAdd` datetime DEFAULT NULL,
  `DateOfUpdate` datetime DEFAULT NULL,
  `Descripton` varchar(300) COLLATE utf8mb3_swedish_ci DEFAULT NULL,
  `IsLangauge` tinyint DEFAULT NULL,
  `Language` char(30) COLLATE utf8mb3_swedish_ci DEFAULT NULL,
  PRIMARY KEY (`Subject_ID`),
  KEY `Subject_ID` (`Subject_ID`) /*!80000 INVISIBLE */,
