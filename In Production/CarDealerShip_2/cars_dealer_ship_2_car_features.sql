...
CREATE TABLE `car_features` (
  ...
  CONSTRAINT `carf_f1_vin` FOREIGN KEY (`VIN`) REFERENCES `inventory` (`Vehicle_Identification_Number`),
  CONSTRAINT `carf_f2_fid` FOREIGN KEY (`feature_id`) REFERENCES `feature_list` (`feature_id`)
...
INSERT INTO `car_features` VALUES (10,1),(34,1),(17,10),(16,11),(10,12),(16,13),(17,14);
