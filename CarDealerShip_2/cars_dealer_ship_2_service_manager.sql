...
CREATE TABLE `service_manager` (
  `service_manager_id` int NOT NULL,
  ...
  CONSTRAINT `Service_Manager_ibfk_1` FOREIGN KEY (`service_manager_id`) REFERENCES `employee` (`Emp_id`),
  CONSTRAINT `Service_Manager_ibfk_2` FOREIGN KEY (`Reports_to`) REFERENCES `dealership_manager` (`dealership_manager_id`)
...
INSERT INTO `service_manager` VALUES (5,1),(6,1),(7,1),(21,1);
