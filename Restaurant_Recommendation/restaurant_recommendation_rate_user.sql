...
CREATE TABLE `rate_user` (
  ...
  UNIQUE KEY `rate_user_id_unique` (`reviewer_id`,`reviewee_id`),
  KEY `reviewee_id` (`reviewee_id`),
  CONSTRAINT `rate_user_ibfk_1` FOREIGN KEY (`reviewer_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE,
  CONSTRAINT `rate_user_ibfk_2` FOREIGN KEY (`reviewee_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE,
