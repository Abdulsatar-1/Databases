...
CREATE TABLE `review_rating` (
  ...
  UNIQUE KEY `review_rating_unique` (`review_id`,`review_rater_id`),
  KEY `review_rater_id` (`review_rater_id`),
  CONSTRAINT `review_rating_ibfk_1` FOREIGN KEY (`review_id`) REFERENCES `review` (`review_id`) ON DELETE CASCADE,
  CONSTRAINT `review_rating_ibfk_2` FOREIGN KEY (`review_rater_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE,
